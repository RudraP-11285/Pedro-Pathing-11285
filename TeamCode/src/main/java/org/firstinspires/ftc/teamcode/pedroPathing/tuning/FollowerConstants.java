...
public class FollowerConstants {
    ...
    private static double xMovement = 5.1622410700622 * Math.pow(10, -17); //81.34056;
    private static double yMovement = 3.5304845866495016 * Math.pow(10, -17);//65.43028;
    ...
    public static double mass = 12.70;
